...
const EditLevelModal = ({ isOpen, closeModal, setLevels, levelId }) => {
  ...
  useEffect(() => {
    adminAxios
      .get(`/getLevelById/${levelId}`)
      .then((res) => {
        const { name, description, image } = res.data.Level;
  ...
  const handleSubmit = (e) => {
    ...
    adminAxios
      .put(`/updateLevel/${levelId}`, newLevel)
      .then((res) => {
        ...
        setLevels((prevLevels) =>
          prevLevels.map((level) => (level._id === levelId ? newLevel : level))
        );
