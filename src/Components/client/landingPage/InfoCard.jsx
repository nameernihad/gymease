...
const BlogPostCard = () => {
  return (
    <div className="flex flex-wrap justify-center gap-4">
      <div className=" mt-10 flex flex-col items-center border border-amber-600 bg-white  rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100  dark:bg-black dark:hover:bg-gray-800">
        <img
      ...
      <div className="flex mt-10 flex-col items-center border border-amber-600 bg-white  rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100  dark:bg-black dark:hover:bg-gray-800">
        <img
          className="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-l-lg"
